...
for c_n in cn_list:
    row = []
    results_filename = os.path.join(results_dir, 'cont_carbon_sw_off_' + str(c_n) + "_diversity_data.pkl")
    ...
    for seed_sim in seed_sim_list:
        ...
        details_subfolder = 'cont_carbon_sw_off_' + str(c_n) + '_'+str(seed_sim) + '_ip_' + str(ip)
