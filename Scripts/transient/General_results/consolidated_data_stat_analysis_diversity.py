...
h.set_ylabel("Initial functional diversity: Variance")
plt.yscale("log")
...
sns.scatterplot(x = 'NOSC_initial', y = 'NOSC_timscale', hue = 'S_initial_int', style = 'DOC_initial_int', data = extr_full, ax = axes[0])
sns.scatterplot(x = 'NOSC_initial', y = 'NOSC_maxbio', hue = 'S_initial_int', style = 'DOC_initial_int', data = extr_full, ax=axes[1])
sns.scatterplot(x = 'NOSC_initial', y = 'NOSC_final', hue = 'S_initial_int', style = 'DOC_initial_int', data = extr_full, ax = axes[2])
...
plt.legend(bbox_to_anchor=(1,1))
#%%
sns.scatterplot(x = "FD_initial", y = "FD_ratio", hue = 'DOC_initial_int', style = "Variance", data = extr_full)
plt.xscale("log")
plt.xlabel("Initial functional diversity: Variance")
plt.ylabel("Functional diversity: Peak/Initial")
plt.legend(bbox_to_anchor=(1, 1))
#%%
sns.scatterplot(x = "FD_initial", y = "Biomass_ratio", hue = 'DOC_initial_int', style = "Variance", data = extr_full)
plt.xscale("log")
plt.xlabel("Initial functional diversity: Variance")
plt.ylabel("Functional diversity: Peak/Initial")
plt.legend(bbox_to_anchor=(1, 1))
