...
#%%
cols_to_merge = ['Seed', 'Sim_series', 'carbon_species', 'biomass_species', 'C_pool', 'T_10', 'T10_base', 'T_20', 'T20_base', 'T_50', 'T50_base', 'activity', 'Variance',  'DOC_initial_int']
...
all_data["Decay_constant_10"] = 1/(all_data['T_10']*5).to_numpy(dtype = float)    
all_data["Decay_constant_20"] = 1/(all_data['T_20']*5).to_numpy(dtype = float)    
all_data["Decay_constant_50"] = 1/(all_data['T_50']*5).to_numpy(dtype = float)
