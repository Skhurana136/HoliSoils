...
#%%
sns.displot(x='CUE', data=extr_full[extr_full['%C']<50], hue = 'Variance', col = 'DOC_initial', row='%C', kind='kde')
#%%
sns.jointplot(x='%C', y = 'CUE', data = act_full, hue = 'DOC_initial')
#%%
sns.displot(x='Biomass', data=extr_full[extr_full['%C']<50], hue = 'Variance', col = 'DOC_initial', row='%C', kind='kde')
#plt.xscale("log")
#%%
sns.jointplot(x='%C', y = 'CUE', data = extr_full, hue = 'Variance')
#%%
