...
#%%
sns.displot(x='DOC_y', data=extr_full[extr_full['%C_x']<50], hue = 'Variance', col = 'DOC_initial_x', row='%C_x', kind='kde')
#%%
sns.jointplot(y='DOC_y', x = '%C_x', data=extr_full, hue = 'Variance')
#%%
#%%
sns.jointplot(y='DOC_y', x = '%C_x', data=extr_full, hue = 'DOC_initial_int')
#%%
###--------------------------------------------------------
