...
all_data = pd.read_pickle(os.path.join(results_dir, "competition_adaptation_seq_carbon__loss_0.9_combined_dataset.pkl"))
...
filestring = "competition_adaptation_seq_carbon_"
...
#%%
func_div = para_df.groupby(['Seed', 'carbon_species', 'Sim_series', 'level_id'])['vmax', 'k', 'm', 'exo_enz'].sum().reset_index()
...
X = seed_paras[['num_cum', 'm', 'exo_enz']]#,'log_doc_initial_int']]
