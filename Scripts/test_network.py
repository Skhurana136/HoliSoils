...
vparams = np.random.normal(0.5, 0.001, bio_n*dom_n)#np.random.uniform(0.001,15,bio_n*dom_n)
...
mparams = np.min(vparams.reshape(dom_n, bio_n),axis=0)/5#15

# initial conditions
dom_initial = np.random.normal(1000, 100, dom_n)#np.random.randint(500,1000,dom_n)
