...
python "/home/x_swakh/tools/HoliSoils/Scripts/Linux/transient/Run_scripts/activity_loss_-02/carbon_switch_off_competition_adaptation_seq.py" "competition_adaptation_seq"
# Scripts ends here