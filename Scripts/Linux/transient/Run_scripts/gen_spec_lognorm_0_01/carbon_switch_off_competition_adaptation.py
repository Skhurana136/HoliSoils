...
project_dir = os.path.join('/proj', 'hs_micro_div_072022', 'Project_data', 'transient', 'gen_spec_lognorm_0_01')
...
def run_sims (experiment, c_n, b_n, dom_initial, seed_sim, Switch_matrix, hw):
    ...
    mu_v = 0.004
    mu_k = 1
    skewness_para = 0.01 #sigma/standard deviation
...
import numpy as np
#%%
random_samples = np.random.lognormal(1, 0.01, 50)
sns.histplot(random_samples)