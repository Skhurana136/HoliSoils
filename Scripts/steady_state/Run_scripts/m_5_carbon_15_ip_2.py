...
c_n = 15
bio_n_series = [3,5,9,12,15,20,25,30]#25 didn't work
ip = 2
...
def run_sims (experiment, c_n, b_n, dom_initial, seed_sim, Switch_matrix, hw):
    ...
    carbon_input = generate_random_boundary_conditions(dom_n, total_dom_initial*t_step/(2*365*dom_n), method_name = "user_defined")#1*total_dom_initial/100
