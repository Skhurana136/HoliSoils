...
details_subfolder = 'm_25_carbon_15_ip_0'
c_n = 15
...
def run_sims (experiment, c_n, b_n, dom_initial, seed_sim, Switch_matrix, hw):
    ...
    ox_state, enzparams, zparams, vparams, kparams, mparams = generate_random_parameters(dom_n, bio_n,25*np.sum(biomass_initial))
